...
<div id="div1">
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("select * FROM munisipius where id_munisipiu like '$id_munisipiu' LIMIT 1");
			while($r=$a->fetch_array()){
				...
				<tr>
					...
					<td>
						Dadus husi <b><?php echo $r['nrn_munisipiu']; ?></b> nian.
					</td>
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("SELECT * FROM klientes, aldeias, sukus, postus, munisipius, nasauns, kuartus WHERE 
				...
				munisipius.id_munisipiu like '$id_munisipiu'
				");
			while($r=$a->fetch_array()){
				?>

...
<div id="div1">
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("select * FROM kuartus where id_kuartu like '$id_kuartu' LIMIT 1");
			while($r=$a->fetch_array()){
				...
				<tr>
					...
					<td>
						Dadus husi <b><?php echo $r['tipu_kuartu']; ?> / <?php echo $r['nu_kuartu']; ?></b> nian.
					</td>
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("SELECT * FROM klientes, aldeias, sukus, postus, munisipius, nasauns, kuartus WHERE 
				...
				kuartus.id_kuartu like '$id_kuartu'
				");
			while($r=$a->fetch_array()){
				?>
